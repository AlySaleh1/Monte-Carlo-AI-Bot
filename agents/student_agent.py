...
class StudentAgent(Agent):
    ...
    def step(self, chess_board, my_pos, adv_pos, max_step):
        ...
        if self.step_counter == 1:
            return self.pure_MCS_move(best_moves, chess_board, adv_pos, start_time, max_step, 29.9)
        else:
            return self.pure_MCS_move(best_moves, chess_board, adv_pos, start_time, max_step, 1.9)
